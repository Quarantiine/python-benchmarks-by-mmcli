...
=========================================
Rich terminal user interface for interactive calculus exploration,
...
if HAS_TEXTUAL:
    class CalculusTUIApp(App):
        ...
        def compose(self) -> ComposeResult:
            ...
            with Container(id="main-container"):
                ...
                with VerticalScroll(id="sidebar"):
                    ...
                    yield Select([(label, expr) for label, expr in PRESETS], prompt="Select preset...", id="preset-select")
        ...
        def on_mount(self) -> None:
            self.title = "Symbolic Calculus Engine"
...
def run_textual_tui() -> bool:
    """Run Textual TUI if textual is installed and working."""
    if not HAS_TEXTUAL:
        return False
    try:
        app = CalculusTUIApp()
